      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 transition-colors duration-500">
        ...
        <main className="max-w-[1920px] mx-auto px-6 py-6 space-y-6">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
            <ErrorBoundary>
              <Suspense fallback={<div className="p-6 bg-slate-100 rounded-lg animate-pulse">Loading Network Graph...</div>}>
                <NetworkGraph />
              </Suspense>
            </ErrorBoundary>

            <ErrorBoundary>
              <Suspense fallback={<div className="p-6 bg-slate-100 rounded-lg animate-pulse">Loading Simulation Control...</div>}>
                <SimulationControl />
              </Suspense>
            </ErrorBoundary>
          </div>
